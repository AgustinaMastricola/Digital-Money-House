...
const ActivityPage = () => {
	...
	return (
		<>
      <div className={clsx({
        "absolute top-0 left-0 z-10 bg-total-black bg-opacity-35 w-full h-full" : isFilterVisible,
        "hidden": !isFilterVisible
          ...
          className={"absolute z-20 bg-total-white mt-24 w-11/12 md:w-[350px] md:right-12 lg:right-[4.2rem] xl:right-[6.4rem] 2xl:right-[8.3rem] md:top-7"}
          ...
          currentFilter={filter} 
			...
			<Container
				className={
					"border border-total-gray border-opacity-15 rounded-lg border-1 bg-total-white drop-shadow-2xl w-11/12 md:w-10/12 flex flex-col "
				}
			>
